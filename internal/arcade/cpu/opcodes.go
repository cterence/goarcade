...
var InstByOpcode = [256]inst{
	...
	{Name: "STAX", Op1: "BC", Op2: "", Length: 1, States: 7, exec: stax}, // 0x02
	{Name: "INX", Op1: "BC", Op2: "", Length: 1, States: 5, exec: inx},   // 0x03
	{Name: "INR", Op1: "B", Op2: "", Length: 1, States: 5, exec: inr},    // 0x04
	{Name: "DCR", Op1: "B", Op2: "", Length: 1, States: 5, exec: dcr},    // 0x05
	{Name: "MVI", Op1: "B", Op2: "", Length: 2, States: 7, exec: mvi},    // 0x06
	{Name: "RLC", Op1: "", Op2: "", Length: 1, States: 4, exec: rlc},     // 0x07
	{Name: "NOP", Op1: "", Op2: "", Length: 1, States: 4, exec: nop},     // 0x08 *NOP
	{Name: "DAD", Op1: "BC", Op2: "", Length: 1, States: 10, exec: dad},  // 0x09
	{Name: "LDAX", Op1: "BC", Op2: "", Length: 1, States: 7, exec: ldax}, // 0x0A
	{Name: "DCX", Op1: "BC", Op2: "", Length: 1, States: 5, exec: dcx},   // 0x0B
	{Name: "INR", Op1: "C", Op2: "", Length: 1, States: 5, exec: inr},    // 0x0C
	{Name: "DCR", Op1: "C", Op2: "", Length: 1, States: 5, exec: dcr},    // 0x0D
	{Name: "MVI", Op1: "C", Op2: "", Length: 2, States: 7, exec: mvi},    // 0x0E
	{Name: "RRC", Op1: "", Op2: "", Length: 1, States: 4, exec: rrc},     // 0x0F

	// 0x10-0x1F
	{Name: "NOP", Op1: "", Op2: "", Length: 1, States: 4, exec: nop},     // 0x10 *NOP
	{Name: "LXI", Op1: "DE", Op2: "", Length: 3, States: 10, exec: lxi},  // 0x11
	{Name: "STAX", Op1: "DE", Op2: "", Length: 1, States: 7, exec: stax}, // 0x12
	{Name: "INX", Op1: "DE", Op2: "", Length: 1, States: 5, exec: inx},   // 0x13
	{Name: "INR", Op1: "D", Op2: "", Length: 1, States: 5, exec: inr},    // 0x14
	{Name: "DCR", Op1: "D", Op2: "", Length: 1, States: 5, exec: dcr},    // 0x15
	{Name: "MVI", Op1: "D", Op2: "", Length: 2, States: 7, exec: mvi},    // 0x16
	{Name: "RAL", Op1: "", Op2: "", Length: 1, States: 4, exec: ral},     // 0x17
	{Name: "NOP", Op1: "", Op2: "", Length: 1, States: 4, exec: nop},     // 0x18 *NOP
	{Name: "DAD", Op1: "DE", Op2: "", Length: 1, States: 10, exec: dad},  // 0x19
	{Name: "LDAX", Op1: "DE", Op2: "", Length: 1, States: 7, exec: ldax}, // 0x1A
	{Name: "DCX", Op1: "DE", Op2: "", Length: 1, States: 5, exec: dcx},   // 0x1B
	{Name: "INR", Op1: "E", Op2: "", Length: 1, States: 5, exec: inr},    // 0x1C
	{Name: "DCR", Op1: "E", Op2: "", Length: 1, States: 5, exec: dcr},    // 0x1D
	{Name: "MVI", Op1: "E", Op2: "", Length: 2, States: 7, exec: mvi},    // 0x1E
	...
	{Name: "ADD", Op1: "C", Op2: "", Length: 1, States: 4, exec: add}, // 0x81
	{Name: "ADD", Op1: "D", Op2: "", Length: 1, States: 4, exec: add}, // 0x82
	{Name: "ADD", Op1: "E", Op2: "", Length: 1, States: 4, exec: add}, // 0x83
	{Name: "ADD", Op1: "H", Op2: "", Length: 1, States: 4, exec: add}, // 0x84
	{Name: "ADD", Op1: "L", Op2: "", Length: 1, States: 4, exec: add}, // 0x85
	{Name: "ADD", Op1: "M", Op2: "", Length: 1, States: 7, exec: add}, // 0x86
	{Name: "ADD", Op1: "A", Op2: "", Length: 1, States: 4, exec: add}, // 0x87
	{Name: "ADC", Op1: "B", Op2: "", Length: 1, States: 4, exec: adc}, // 0x88
	{Name: "ADC", Op1: "C", Op2: "", Length: 1, States: 4, exec: adc}, // 0x89
	{Name: "ADC", Op1: "D", Op2: "", Length: 1, States: 4, exec: adc}, // 0x8A
	{Name: "ADC", Op1: "E", Op2: "", Length: 1, States: 4, exec: adc}, // 0x8B
	{Name: "ADC", Op1: "H", Op2: "", Length: 1, States: 4, exec: adc}, // 0x8C
	{Name: "ADC", Op1: "L", Op2: "", Length: 1, States: 4, exec: adc}, // 0x8D
	{Name: "ADC", Op1: "M", Op2: "", Length: 1, States: 7, exec: adc}, // 0x8E
	{Name: "ADC", Op1: "A", Op2: "", Length: 1, States: 4, exec: adc}, // 0x8F

	// 0x90-0x9F
	{Name: "SUB", Op1: "B", Op2: "", Length: 1, States: 4, exec: sub}, // 0x90
	{Name: "SUB", Op1: "C", Op2: "", Length: 1, States: 4, exec: sub}, // 0x91
	{Name: "SUB", Op1: "D", Op2: "", Length: 1, States: 4, exec: sub}, // 0x92
	{Name: "SUB", Op1: "E", Op2: "", Length: 1, States: 4, exec: sub}, // 0x93
	{Name: "SUB", Op1: "H", Op2: "", Length: 1, States: 4, exec: sub}, // 0x94
	{Name: "SUB", Op1: "L", Op2: "", Length: 1, States: 4, exec: sub}, // 0x95
	{Name: "SUB", Op1: "M", Op2: "", Length: 1, States: 7, exec: sub}, // 0x96
	{Name: "SUB", Op1: "A", Op2: "", Length: 1, States: 4, exec: sub}, // 0x97
	{Name: "SBB", Op1: "B", Op2: "", Length: 1, States: 4, exec: sbb}, // 0x98
	{Name: "SBB", Op1: "C", Op2: "", Length: 1, States: 4, exec: sbb}, // 0x99
	{Name: "SBB", Op1: "D", Op2: "", Length: 1, States: 4, exec: sbb}, // 0x9A
	{Name: "SBB", Op1: "E", Op2: "", Length: 1, States: 4, exec: sbb}, // 0x9B
	{Name: "SBB", Op1: "H", Op2: "", Length: 1, States: 4, exec: sbb}, // 0x9C
	{Name: "SBB", Op1: "L", Op2: "", Length: 1, States: 4, exec: sbb}, // 0x9D
	{Name: "SBB", Op1: "M", Op2: "", Length: 1, States: 7, exec: sbb}, // 0x9E
	{Name: "SBB", Op1: "A", Op2: "", Length: 1, States: 4, exec: sbb}, // 0x9F

	// 0xA0-0xAF
	{Name: "ANA", Op1: "B", Op2: "", Length: 1, States: 4, exec: ana}, // 0xA0
	{Name: "ANA", Op1: "C", Op2: "", Length: 1, States: 4, exec: ana}, // 0xA1
	{Name: "ANA", Op1: "D", Op2: "", Length: 1, States: 4, exec: ana}, // 0xA2
	{Name: "ANA", Op1: "E", Op2: "", Length: 1, States: 4, exec: ana}, // 0xA3
	{Name: "ANA", Op1: "H", Op2: "", Length: 1, States: 4, exec: ana}, // 0xA4
	{Name: "ANA", Op1: "L", Op2: "", Length: 1, States: 4, exec: ana}, // 0xA5
	{Name: "ANA", Op1: "M", Op2: "", Length: 1, States: 7, exec: ana}, // 0xA6
	{Name: "ANA", Op1: "A", Op2: "", Length: 1, States: 4, exec: ana}, // 0xA7
	{Name: "XRA", Op1: "B", Op2: "", Length: 1, States: 4, exec: xra}, // 0xA8
	{Name: "XRA", Op1: "C", Op2: "", Length: 1, States: 4, exec: xra}, // 0xA9
	{Name: "XRA", Op1: "D", Op2: "", Length: 1, States: 4, exec: xra}, // 0xAA
	{Name: "XRA", Op1: "E", Op2: "", Length: 1, States: 4, exec: xra}, // 0xAB
	{Name: "XRA", Op1: "H", Op2: "", Length: 1, States: 4, exec: xra}, // 0xAC
	{Name: "XRA", Op1: "L", Op2: "", Length: 1, States: 4, exec: xra}, // 0xAD
	{Name: "XRA", Op1: "M", Op2: "", Length: 1, States: 7, exec: xra}, // 0xAE
	{Name: "XRA", Op1: "A", Op2: "", Length: 1, States: 4, exec: xra}, // 0xAF

	// 0xB0-0xBF
	{Name: "ORA", Op1: "B", Op2: "", Length: 1, States: 4, exec: ora}, // 0xB0
	{Name: "ORA", Op1: "C", Op2: "", Length: 1, States: 4, exec: ora}, // 0xB1
	{Name: "ORA", Op1: "D", Op2: "", Length: 1, States: 4, exec: ora}, // 0xB2
	{Name: "ORA", Op1: "E", Op2: "", Length: 1, States: 4, exec: ora}, // 0xB3
	{Name: "ORA", Op1: "H", Op2: "", Length: 1, States: 4, exec: ora}, // 0xB4
	{Name: "ORA", Op1: "L", Op2: "", Length: 1, States: 4, exec: ora}, // 0xB5
	{Name: "ORA", Op1: "M", Op2: "", Length: 1, States: 7, exec: ora}, // 0xB6
	{Name: "ORA", Op1: "A", Op2: "", Length: 1, States: 4, exec: ora}, // 0xB7
	{Name: "CMP", Op1: "B", Op2: "", Length: 1, States: 4, exec: cmp}, // 0xB8
	{Name: "CMP", Op1: "C", Op2: "", Length: 1, States: 4, exec: cmp}, // 0xB9
	{Name: "CMP", Op1: "D", Op2: "", Length: 1, States: 4, exec: cmp}, // 0xBA
	{Name: "CMP", Op1: "E", Op2: "", Length: 1, States: 4, exec: cmp}, // 0xBB
	{Name: "CMP", Op1: "H", Op2: "", Length: 1, States: 4, exec: cmp}, // 0xBC
	{Name: "CMP", Op1: "L", Op2: "", Length: 1, States: 4, exec: cmp}, // 0xBD
	{Name: "CMP", Op1: "M", Op2: "", Length: 1, States: 7, exec: cmp}, // 0xBE
